...
class LuaVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LuaParser#tail_required_field.
    def visitTail_required_field(self, ctx:LuaParser.Tail_required_fieldContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LuaParser#tail_optional_field.
    def visitTail_optional_field(self, ctx:LuaParser.Tail_optional_fieldContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LuaParser#tail_call_with_pipe.
    def visitTail_call_with_pipe(self, ctx:LuaParser.Tail_call_with_pipeContext):
        return self.visitChildren(ctx)
